...
<div class="card-header">
        ...
        Master Data > Tambah Akun Group Petty Cash
</div>
        ...
        <div class="row justify-content-center"> 
            <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg my-5">
                    <div class="card-header">
                        <h4 class="text-center font-weight-light my-4">Tambah Akun Group Petty Cash</h4>
                    </div>
                            ...
                            <div class="form-row">
                                <div class="col-md">
                                    <div class="form-group">
                                        <label class="small mb-1" for="nama">Akun Group Petty Cash</label>
