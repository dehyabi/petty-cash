...
<div class="card-header">
    <a href="{{ route('all.city') }}"><i class="fas fa-arrow-left"></i></a> <span class="ml-2">Lokasi Outlet > Master Lokasi > Update Kota</span>
</div>
                            ...
                            <div class="form-row">
                                <div class="col-md">
                                    <div class="form-group">
                                        ...
                                        <input required class="form-control py-4" name="kota" type="text" value="{{ $city->kota }}">
                                    </div>
                                </div>
                            </div>

                            <div class="form-group mt-4 mb-0"><button class="btn btn-info btn-block mb-4">Update Kota</button></div>        
                        </form>
                    </div>
                </div>
            </div>
