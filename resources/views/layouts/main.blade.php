...
if ($pathUser === 'add-user' || $pathUser === 'add-group-user' || $pathUser === 'all-user' || $pathUser === 'all-group-user' || $pathUser === 'edit-group-user' || $pathUser === 'confirm-delete-group-user' || $pathUser === 'confirm-delete-user' || $pathUser === 'edit-user') {
    $pathUser = 'active';
}

$pathPettyCash = $_SERVER['REQUEST_URI'];
$pathPettyCash = preg_replace('/[^a-zA-Z_-]/s','',$pathPettyCash);
if ($pathPettyCash === 'add-petty-cash' || $pathPettyCash === 'add-group-petty-cash' || $pathPettyCash === 'all-group-petty-cash' || $pathPettyCash === 'all-petty-cash' || $pathPettyCash === 'edit-group-petty-cash' || $pathPettyCash === 'confirm-delete-group-petty-cash' || $pathPettyCash === 'confirm-delete-petty-cash' || $pathPettyCash === 'edit-petty-cash') {
