        ...
        <div class="row justify-content-center"> 
            <div class="col-lg-7">
                <div class="card border-0 rounded-lg my-5">
                    ...
                    @endif                    
                    <div class="card-body">
                        <form method="POST" action="{{ route('update.jenis.pembelian', $jenis_pembelian->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-row">
                                <div class="col-md">
                                    <div class="form-group">
                                        ...
                                        <input required class="form-control py-4" name="jenis_pembelian" type="text" value="{{ $jenis_pembelian->jenis_pembelian }}">
                                    </div>
                                </div>
                            </div>

                            <div class="form-group mt-4 mb-0"><button class="btn btn-info btn-block mb-4">Update Jenis Pembelian</button></div>        
                        </form>
                    </div>
                </div>
            </div>
